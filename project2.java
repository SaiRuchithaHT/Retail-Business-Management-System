// usage:  1. compile: javac -cp /usr/lib/oracle/18.3/client64/lib/ojdbc8.jar project2.java
//         2. execute: java -cp /usr/lib/oracle/18.3/client64/lib/ojdbc8.jar project2.java
...
// Define a public class named project2
public class project2 {
    ...
    public static void add_employee(String e_id, String employeeName, String telephoneNumber, String email,
        ...
        try {
            // Prepare the statement to call the stored procedure
            CallableStatement cs = conn.prepareCall("{call project2_package.add_employee(?, ?, ?, ?, ?)}");
    ...
    public static void add_purchase(String e_id, String p_id, String c_id, int pur_qty, double pur_unit_price,
        ...
        try {
            ...
            CallableStatement cs = conn.prepareCall("{call project2_package.add_purchase(?, ?, ?, ?, ?, ?)}");
    ...
    public static void show_employees(Connection conn) {
        try {
            ...
            CallableStatement cs = conn.prepareCall("{call project2_package.show_employees(?)}");
            // Register output parameter for the cursor
    ...
    public static void show_customers(Connection conn) {
        try {
            ...
            CallableStatement cs = conn.prepareCall("{call project2_package.show_customers(?)}");
            cs.registerOutParameter(1, OracleTypes.CURSOR);
    ...
    public static void show_products(Connection conn) {
        ...
        try {
            ...
            // call to stored procedure
            CallableStatement cs = conn.prepareCall("{call project2_package.show_products(?)}");
            cs.registerOutParameter(1, OracleTypes.CURSOR);
    ...
    public static void show_prod_discnt(Connection conn) {
        ...
        try {
            ...
            CallableStatement cs = conn.prepareCall("{call project2_package.show_prod_discnt(?)}");
    ...
    public static void show_purchases(Connection conn) {
        ...
        try {
            ...
            CallableStatement cs = conn.prepareCall("{call project2_package.show_purchases(?)}");
    ...
    public static void show_logs(Connection conn) {
        try {
            ...
            CallableStatement cs = conn.prepareCall("{call project2_package.show_logs(?)}");
